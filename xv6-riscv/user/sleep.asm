...
int main(int argc, char *argv[])
{
  ...
  if (argc < 2)
   c:	4785                	li	a5,1
   e:	00a7dd63          	bge	a5,a0,28 <main+0x28>
  {
    printf("USAGE: sleep <ticks>");
  }
  int ticks = atoi(argv[1]);
  12:	6488                	ld	a0,8(s1)
  14:	194000ef          	jal	1a8 <atoi>

  pause(ticks);
  18:	342000ef          	jal	35a <pause>
}
  1c:	4501                	li	a0,0
  1e:	60e2                	ld	ra,24(sp)
  20:	6442                	ld	s0,16(sp)
  ...
  2c:	88850513          	addi	a0,a0,-1912 # 8b0 <malloc+0xfa>
  30:	6d2000ef          	jal	702 <printf>
  34:	bff9                	j	12 <main+0x12>
...
printint(int fd, long long xx, int base, int sgn)
{
 ...
 3b6:	51e50513          	addi	a0,a0,1310 # 8d0 <digits>
 3ba:	883e                	mv	a6,a5
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 64c:	288b8b93          	addi	s7,s7,648 # 8d0 <digits>
 ...
 6ae:	21e90913          	addi	s2,s2,542 # 8c8 <malloc+0x112>
        for(; *s; s++)
